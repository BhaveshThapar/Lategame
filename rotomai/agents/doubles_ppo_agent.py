...
from rotomai.agents.doubles_agent import CHECKPOINT_ENV_VAR, DEFAULT_CHECKPOINT, DoublesAgent
...
from rotomai.features.doubles_encoder import embed_doubles_battle
...
class DoublesPPORecordingAgent(PPORecordMixin, DoublesAgent):
    ...
    def choose_move(self, battle: AbstractBattle) -> BattleOrder:
        from rotomai.model.policy import factored_logits, sample_factored_action
