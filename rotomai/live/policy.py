...
``rotomai/cli.py`` imports it at module scope to build ``--help`` text, and paying a torch import
for ``rotomai --help`` would be absurd.
...
USERNAME_ENV = "ROTOMAI_PS_USERNAME"
PASSWORD_ENV = "ROTOMAI_PS_PASSWORD"

#: The second of the two ladder channels (the first is ``--ladder-ack``).
ALLOW_LADDER_ENV = "ROTOMAI_LIVE_ALLOW_LADDER"
